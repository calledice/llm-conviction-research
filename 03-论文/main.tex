...
\begin{document}
\maketitle
\begin{center}\small\textbf{v1 | Position paper and research agenda.}\end{center}
...
\textbf{Literature coverage is selective.} The synthesis draws on a targeted selection of relevant work. Incomplete coverage remains possible, especially across philosophy, languages, and very recent preprints. Broader searches and specialist review could refine both the conceptual distinctions and the proposed comparisons.
...
The accompanying project contains original research notes, a proposed protocol, citation metadata, and document sources. The research materials are available in the project repository \href{https://github.com/calledice/llm-conviction-research}{calledice/llm-conviction-research}. Downloaded source texts and local working caches are excluded. The author has selected the arXiv perpetual, non-exclusive distribution license for the intended deposit. Other rights are reserved, and no general reuse license is granted for the repository.
